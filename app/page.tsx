  ...
  return (
    <div className="w-full h-screen flex items-center text-center justify-center flex-col ">
      ...
      <div className="flex justify-center ">
        <a className="flex justify-center items-center no-underline text-black text-[100px] mt-[10px] p-[30px] w-fit rounded-[60%] hover:scale-[130%] hover:bg-zinc-300 transition-[10s]" href="./jogo"><FaPlay /></a>
      </div>
    </div>
  )
}
